...
capability exposure interface. It manages the session-based operation of the NDT, managing the life-cycle of these
operations under the direction of associated applications through intent input interface; it monitors the
performance and resource consumption of the NDT (including individual models); and controls various operational
aspects of the NDT, including topology management, model management and security management.
