...
A Network Digital Twin Management subsystem manages the operation of the NDT and its components to useful
...
associated applications; it monitors the performance and resource consumption of the NDT or even of individual
models; and controls various operational elements and aspects of the NDT, including topology management, model
